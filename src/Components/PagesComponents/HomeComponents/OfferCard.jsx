...
const OfferCard = ({first,last,img}) => {
    return (
      <div className='h-50'>
         <div className={`rounded-sm h-45 w-124 absolute bg-cover  flex justify-center items-end flex-col text-white pr-10 space-y-2 text-end`} style={{ backgroundImage: `url(${img})` }} >
